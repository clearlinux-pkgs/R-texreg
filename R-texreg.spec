...
Source0  : https://cran.r-project.org/src/contrib/texreg_1.38.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646418918
...
/usr/lib64/R/library/texreg/tests/testthat/texreg_1.37.4.tar.gz
