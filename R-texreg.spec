...
Version  : 1.37.5
Release  : 19
URL      : https://cran.r-project.org/src/contrib/texreg_1.37.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/texreg_1.37.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592587765
